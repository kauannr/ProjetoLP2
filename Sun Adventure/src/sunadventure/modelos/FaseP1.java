...
public class FaseP1 extends JPanel implements ActionListener {

	private Image fundo;
	private Player player, player2;
	private Timer timer, timer2;
	private boolean emJogo, emExplosao, emJogo2;
	...
	public FaseP1() throws IOException {
		...
		setFocusable(true); // Esses dois metodos são para melhorar o
		setDoubleBuffered(true);// desempenho do jogo

		// Teclado
		addKeyListener(new TecladoAdapter());

		// Fundo da fase
		ImageIcon referencia = new ImageIcon("res\\Blackground.png"); // referencia recebe uma imagem
		fundo = referencia.getImage(); // o obejto fundo pega a imagem passada como referencia
		...
		// Timers
		waitForSeconds();
		timer = new Timer(7, this); // Aqui é a velocidade do jogo, quanto maior, mais rapido
		timer.start();
	...
	public void actionPerformed(ActionEvent e) {
		...
		checarColisoes();
		repaint(); // Metodo pra repintar e n ficar duas imagens iguais na tela
	...
	public void paint(Graphics g) {
		...
		if (emJogo) { // se iniciar o jogo
			// Fundo
			graficos.drawImage(fundo, 0, 0, null); // printa na tela a imagem passada, no meio da tela do pc
